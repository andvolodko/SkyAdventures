...
* 	contribution :	NNLGBitmapData now extends BitmapData, performance optimizations
* 	date :			2009-10-16
* 
...
* 	DESCRIPTION **************************************************************************
* 
* 	NNLGBitmapData is an AS3 Bitmap drawing library. It provide some functions to draw directly 
...
package org.volodko.engine
{
	...
	public class VBitmapData extends BitmapData
	{
		...
		public function VBitmapData ( width:uint, height:uint, transparent:Boolean=true, color:uint=0xFFFFFFFF )
		{
		...
		/*
		 * Clone NNLGBitmapdata
		 */
		public function cloneBD():VBitmapData {
			var ret:VBitmapData = new VBitmapData(width, height, transparent);
			ret.setVector(rect, getVector(rect));
			return ret;
		}
