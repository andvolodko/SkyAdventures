...
package org.volodko.engine
{
	...
	public class Keys extends Module
	{
		...
		// Num Lock number
		public var N0:Boolean;
		public var N1:Boolean;
		public var N2:Boolean;
		public var N3:Boolean;
		public var N4:Boolean;
		public var N5:Boolean;
		public var N6:Boolean;
		public var N7:Boolean;
		public var N8:Boolean;
		public var N9:Boolean;
		...
		public function Keys()
		{
			...
			GLB.stage.addEventListener(KeyboardEvent.KEY_DOWN, handleKeyDown);
			GLB.stage.addEventListener(KeyboardEvent.KEY_UP, handleKeyUp);
		 ...
		 */
		public function justPressed(Key:String):Boolean { return map[lookup[Key]].current == 2; }
		 ...
		 */
		public function justReleased(Key:String):Boolean { return map[lookup[Key]].current == -1; }
		
		/**
		 * Event handler so Game can toggle keys.
		 * 
		 * @param	event	A <code>KeyboardEvent</code> object.
		 */
		public function handleKeyDown(event:KeyboardEvent):void
		{
			var o:Object = map[event.keyCode];
			if(o == null) return;
		...
		public function handleKeyUp(event:KeyboardEvent):void
		{
			...
			this[o.name] = false;
			//dispatch(Msg.GLB_KEY_UP, o.name); //trace(o.name);
		}
		...
		protected function addKey(KeyName:String,KeyCode:uint):void
		{
			...
			map[KeyCode] = { name: KeyName, current: 0, last: 0 };
		}
