...
public class ParallaxTileLayerLogic extends TileLayerLogic {
    ...
    public function ParallaxTileLayerLogic(entity:Entity, tileXML:XMLList, sortIndex:Point, xCoef:Number, yCoef:Number) {
        this.xCoef = xCoef;
        this.yCoef = yCoef;
        super(entity, tileXML, sortIndex);
        trace("ParallaxTileLayerLogic ",xCoef,yCoef);
    }
